...
import { ActionLog, AuthenticationDetails, UserWithRole } from 'src/app/models/master';
import { NotificationSnackBarComponent } from 'src/app/notifications/notification-snack-bar/notification-snack-bar.component';
import { SnackBarStatus } from 'src/app/notifications/snackbar-status-enum';
...
export class NewDoucumentComponent implements OnInit {
  ...
  MAC_address = ""
  IP_address = "";
  toppingList: string[] = ['VSure', 'Self',  'Token', 'Company Certificate','Tag'];
  ...
  flagadduser1: boolean = false;
  flagaddhide1: boolean = true;
  date: Date = new Date();
  newdocid = "";
  newattid = "";
  select: any;
...
//   this._mailservice.GetMailAttachments().subscribe(
//     data => {
//         console.log(data, "MailAttachment");
//         // this.file.push(data);
//         var count = data.length;

//         for (var i = 0; i < count; i++) {
//             // Attachment att = atts[i];
//             const base64 = data[i].content;
//             const pdfName = data[i].name;
...
//             this.name1 = pdfFile[this.i].name;
//             this.size = pdfFile[this.i].size;
//             this.flag = true;
//             console.log(this.name1);

//             this.size = (pdfFile[this.i].size) / 1024 * 1000 + "kb"
...
onCreate() {
  ...
  this.flagadduser1 = false;
  this.flagaddhide1 =false;
console.log("flagadduser in onCreate",this.flagadduser)
console.log("flagaddhide in onCreate",this.flagaddhide)
...
onCreatee() {
  // this.panelOpenState=true;
  this.flagadduser1 = true;
  this.flagaddhide1 = !this.flagaddhide;
  this.flagadduser=false;
  this.flagaddhide=true;

  console.log("flagadduser in onCreatee",this.flagadduser1)
console.log("flagaddhide in onCreatee",this.flagaddhide1)
  this.form.patchValue({ select: 'user/Email' });
  this.change('user/Email')
