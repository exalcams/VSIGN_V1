...
export class DashboardService1 {
 ...
 // baseurl = 'http://192.168.0.25:5090/';
  //baseAddress="http://192.168.0.25:5090/"
   baseAddress='http://localhost:61067/'
  ...
  DeleteData(DocId:any):Observable<any>{
    return this.httpClient.get<any>(`http://localhost:61067/api/SaveDoc/DeleteData?DocId=${DocId}`);
  }
  ...
  sendEmail1(formdata: any) {
    ...
    console.log(formdata);
    return this.httpClient.post<any>("http://localhost:61067/api/SendRemainder/sendEmail1", formdata);
  }
